...
execute "defaults write com.apple.dock wvous-tl-corner -int 2 && defaults write com.apple.dock wvous-tl-modifier -int 0" \
    "Set Top Left to Mission Control (all windows)"

execute "defaults write com.apple.dock wvous-bl-corner -int 11 && defaults write com.apple.dock wvous-bl-modifier -int 0" \
